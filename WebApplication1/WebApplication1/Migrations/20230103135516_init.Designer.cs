            ...
            modelBuilder.Entity("WebApplication1.Entities.Ogrenci", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2023, 1, 3, 16, 55, 16, 32, DateTimeKind.Local).AddTicks(8166),
                            FullName = "Hasan",
                            Password = "11111111",
                            Role = "admin",
                            StudentName = "hasan"
                        ...
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2023, 1, 3, 16, 55, 16, 32, DateTimeKind.Local).AddTicks(8168),
                            FullName = "mevlut",
                            Password = "11111111",
                            Role = "user",
                            StudentName = "mevlut"
                        ...
                        {
                            Id = 3,
                            CreatedAt = new DateTime(2023, 1, 3, 16, 55, 16, 32, DateTimeKind.Local).AddTicks(8170),
                            FullName = "ibrahim",
                            Password = "11111111",
                            Role = "user",
                            StudentName = "ibrahim"
