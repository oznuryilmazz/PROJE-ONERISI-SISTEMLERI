    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 1, 3, 16, 55, 16, 32, DateTimeKind.Local).AddTicks(8166), "Hasan", "11111111", null, "admin", "hasan" },
                    { 2, new DateTime(2023, 1, 3, 16, 55, 16, 32, DateTimeKind.Local).AddTicks(8168), "mevlut", "11111111", null, "user", "mevlut" },
                    { 3, new DateTime(2023, 1, 3, 16, 55, 16, 32, DateTimeKind.Local).AddTicks(8170), "ibrahim", "11111111", null, "user", "ibrahim" }
                });
